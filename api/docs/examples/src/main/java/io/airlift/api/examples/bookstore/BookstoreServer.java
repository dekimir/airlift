 ...
 *
 * The server will start on port 8080 and you can access:
 *   - List books: GET http://localhost:8080/v1/bookstore/books
 *   - Get book: GET http://localhost:8080/v1/bookstore/books/{bookId}
 *   - Create book: POST http://localhost:8080/v1/bookstore/books
 *   - Update book: PATCH http://localhost:8080/v1/bookstore/books/{bookId}
 *   - Delete book: DELETE http://localhost:8080/v1/bookstore/books/{bookId}
 *   - OpenAPI spec: GET http://localhost:8080/openapi
 */
public class BookstoreServer
{
    ...
    public static void main(String[] args)
    {
        ...
        log.info("  List books:   GET    %s/v1/bookstore/books", server.getBaseUri());
        log.info("  Get book:     GET    %s/v1/bookstore/books/{bookId}", server.getBaseUri());
        log.info("  Create book:  POST   %s/v1/bookstore/books", server.getBaseUri());
        log.info("  Update book:  PATCH  %s/v1/bookstore/books/{bookId}", server.getBaseUri());
        log.info("  Delete book:  DELETE %s/v1/bookstore/books/{bookId}", server.getBaseUri());
        log.info("");
        log.info("  OpenAPI spec: GET    %s/openapi", server.getBaseUri());
        log.info("======================================================");
