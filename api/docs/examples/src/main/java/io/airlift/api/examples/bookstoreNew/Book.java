        ...
        @ApiUnwrapped BookData data)
{
            ...
            extends ApiStringId<Book>
    {
        ...
        // ValidatorException: [Could not deserialize Resource io.airlift.api.examples.bookstoreNew.Book.
        // Error: Cannot construct instance of `io.airlift.api.examples.bookstoreNew.Book$Id` (although at least one Creator exists):
        ...
        // ValidatorException: [Could not instantiate record io.airlift.api.examples.bookstoreNew.Book.
        // Message: [Could not create default value for ApiAbstractId io.airlift.api.examples.bookstoreNew.Book$Id]]
        public Id()
        {
            super(".");
        }
